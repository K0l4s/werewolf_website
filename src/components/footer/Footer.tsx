      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <Link
                to="https://discord.gg/kDkydXrtua"
                className="text-zinc-400 hover:text-violet-300 transition-colors flex items-center gap-1"
                target="_blank"
                rel="noopener noreferrer"
              >
            ...
            <li>
              <Link
                to="https://top.gg/discord/servers/747894754633043968?s=0eaec2fe15c42"
                className="text-zinc-400 hover:text-violet-300 transition-colors flex items-center gap-1"
                target="_blank"
                rel="noopener noreferrer"
              >
      ...
      <div className="mt-12 pt-8 border-t border-zinc-800">
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
          ...
          <div className="flex-1 space-y-3">
            ...
            <p className="text-sm text-zinc-500">
              Contact for work:{" "}
              <Link
                to="mailto:trungkienhuynh.contact@gmail.com?subject=Werewolf Bot Inquiry"
                className="text-violet-300 hover:text-violet-200 underline transition-colors duration-200"
              >
          ...
          <div className="flex-shrink-0">
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-3 border border-zinc-700/50 hover:border-zinc-600/50 transition-all duration-300 group">
              <div className="text-center mb-2">
                <span className="text-xs text-zinc-400 font-medium">Donate</span>
              </div>
              <img
                src="https://i.ibb.co/5hyjcdXc/d843e510-f7ed-4b6d-ac8a-1f87aae068db.jpg"
                alt="QR Code"
                className="w-60 h-44 object-cover object-center mx-auto rounded-lg shadow-lg group-hover:scale-105 transition-transform duration-300"
              />
              <div className="text-center mb-2">
                <span className="text-xs text-zinc-400 font-medium">HUYNH TRUNG KIEN | </span>
                <span className="text-xs text-zinc-400 font-medium">STK: 8888827626203</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 pt-4 border-t border-zinc-800/50">
          <div className="flex flex-wrap gap-4 text-xs text-zinc-600">
            <Link to="/policy" className="hover:text-zinc-400 transition-colors duration-200">
              Privacy Policy
            </Link>
            <Link to="/term" className="hover:text-zinc-400 transition-colors duration-200">
              Terms of Service
            </Link>
            <Link to="/doc" className="hover:text-zinc-400 transition-colors duration-200">
              Documentation
            </Link>
            <a
